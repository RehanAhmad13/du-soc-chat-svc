...
import './ThreadListRow.css';

dayjs.extend(relativeTime);

export default function ThreadListRow({ thread, isSelected, onSelect, onClick, context = 'general' }) {
  ...
  return (
    <div 
      className={`list-row ${isSelected ? 'selected' : ''} ${thread.priority} ${context}`}
    ...
    >
      ...
      {/* SLA - Only show in incidents context */}
      {context === 'incidents' && (
