...
export default function ThreadCard({ thread, isSelected, onSelect, onClick }) {
  ...
  const getSLAProgress = () => {
    // Calculate SLA progress based on creation time and SLA hours
  ...
  return (
    <div 
      className={`thread-card ${isSelected ? 'selected' : ''} ${thread.priority}`}
